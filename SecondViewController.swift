...
//
    ...
    // MARK: circular border for button
//        self.applyRoundCorner(createTest)
...
class SecondViewController: UIViewController {
    ...
    @IBAction func createTestTapped(_ sender: Any)
    {
    ...
    private lazy var popupView: UIView = {
        let view = UIView()
        view.backgroundColor = #colorLiteral(red: 0.9959053397, green: 0.9271895289, blue: 0.9195286632, alpha: 1)
